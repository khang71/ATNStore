...
function kid_toys_store_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'kid_toys_store_preloader_hide',array(
		'default' => false,
      	'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ) );
	...
	$wp_customize->add_control('kid_toys_store_theme_options',
	    array(
	        'type' => 'radio',
	        'label' => __('Sidebar Options','kid-toys-store'),
	        'section' => 'kid_toys_store_left_right',
	        'choices' => array(
	...
	$wp_customize->add_setting('kid_toys_store_topbar_top_bottom',array(
		'default'=> '',
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_topbar_top_bottom',array(
		'label'	=> __('Topbar Top Bottom Padding','kid-toys-store'),
		'input_attrs' => array(
            'step' => 1,
			'min'  => 0,
			'max'  => 50,
    ...
    $wp_customize->add_setting('kid_toys_store_sticky_header_padding', array(
		'default'=> '',
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_sticky_header_padding', array(
		'label'	=> __('Sticky Header Padding','kid-toys-store'),
		'input_attrs' => array(
            'step' => 1,
			'min'  => 0,
			'max'  => 50,
	...
	$wp_customize->add_setting('kid_toys_store_email_icon',array(
		'default'	=> 'fas fa-envelope',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_email_icon',array(
		'label'	=> __('Mail Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('kid_toys_store_phone_icon',array(
		'default'	=> 'fas fa-phone',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_phone_icon',array(
		'label'	=> __('Phone Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar',
		'type'		=> 'icon'
	)));
    ...
    $wp_customize->add_setting('kid_toys_store_call',array(
		'default'	=> '',
		'sanitize_callback'	=> 'kid_toys_store_sanitize_phone_number'
	));
	...
	$wp_customize->add_setting('kid_toys_store_navigation_case',array(
        'default' => 'capitalize',
        'sanitize_callback' => 'kid_toys_store_sanitize_choices'
	));
	$wp_customize->add_control('kid_toys_store_navigation_case',array(
        'type' => 'select',
        'label' => __('Navigation Case','kid-toys-store'),
        'section' => 'kid_toys_store_topbar',
        'choices' => array(
            'uppercase' => __('Uppercase','kid-toys-store'),
            'capitalize' => __('Capitalize','kid-toys-store'),
        ),
	) );

	$wp_customize->add_setting( 'kid_toys_store_nav_font_size', array(
		'default'           => 15,
		'sanitize_callback' => 'kid_toys_store_sanitize_float',
	) );
	$wp_customize->add_control( 'kid_toys_store_nav_font_size', array(
		'label' => __( 'Navigation Font Size','kid-toys-store' ),
		'section'     => 'kid_toys_store_topbar',
		'type'        => 'number',
		'input_attrs' => array(
			'step' => 1,
	...
	$wp_customize->add_setting('kid_toys_store_youtube_icon',array(
		'default'	=> 'fab fa-youtube',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_youtube_icon',array(
		'label'	=> __('Youtube Icon','kid-toys-store'),
	...
	$wp_customize->add_setting('kid_toys_store_facebook_icon',array(
		'default'	=> 'fab fa-facebook-f',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_facebook_icon',array(
		'label'	=> __('Facebook Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('kid_toys_store_twitter_icon',array(
		'default'	=> 'fab fa-twitter',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_twitter_icon',array(
		'label'	=> __('Twitter Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('kid_toys_store_rss_icon',array(
		'default'	=> 'fas fa-rss',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_rss_icon',array(
		'label'	=> __('RSS Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'type'		=> 'icon'
	)));
	...
	$wp_customize->add_setting('kid_toys_store_linkedin_icon',array(
		'default'	=> 'fab fa-linkedin-in',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_linkedin_icon',array(
		'label'	=> __('LinkedIn Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('kid_toys_store_linkedin_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('kid_toys_store_linkedin_url',array(
		'label'	=> __('Add LinkedIn link','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'setting'	=> 'kid_toys_store_linkedin_url',
		'type'	=> 'url'
	));

	$wp_customize->add_setting('kid_toys_store_insta_icon',array(
		'default'	=> 'fab fa-instagram',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_insta_icon',array(
		'label'	=> __('Instagram Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('kid_toys_store_instagram_url',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw'
	));	
	$wp_customize->add_control('kid_toys_store_instagram_url',array(
		'label'	=> __('Add Instagram link','kid-toys-store'),
		'section'	=> 'kid_toys_store_topbar_header',
		'setting'	=> 'kid_toys_store_instagram_url',
		'type'	=> 'url'
	));

	/*social-icon font size*/
	$wp_customize->add_setting('kid_toys_store_social_icon_fontsize',array(
		'default'=> '',
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_social_icon_fontsize',array(
		'label'	=> __('Social Icons Font Size','kid-toys-store'),
		'input_attrs' => array(
            'step' => 1,
			'min'  => 0,
			'max'  => 100,
	...
	$wp_customize->add_setting( 'kid_toys_store_slider_button_text', array(
		'default'   => __('SHOP NOW','kid-toys-store' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	...
	$wp_customize->add_setting( 'kid_toys_store_slider_height', array(
		'default'  => ' ',
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	) );
	$wp_customize->add_control( 'kid_toys_store_slider_height', array(
		'label' => esc_html__('Slider Height','kid-toys-store'),
		'section' => 'kid_toys_store_slidersettings',
		'type'  => 'number',
		'input_attrs' => array(
			'step' => 5,
    ...
    $wp_customize->add_setting('kid_toys_store_time_hide',array(
       'default' => false,
       'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('kid_toys_store_time_hide',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Post Time','kid-toys-store'),
       'section' => 'kid_toys_store_blog_post'
    ));

    $wp_customize->add_setting('kid_toys_store_feature_image_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('kid_toys_store_feature_image_hide',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Featured Image','kid-toys-store'),
       'section' => 'kid_toys_store_blog_post'
    ));

    $wp_customize->add_setting( 'kid_toys_store_featured_image_border_radius', array(
		'default' => 0,
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	) );
	$wp_customize->add_control( 'kid_toys_store_featured_image_border_radius', array(
		'label' => __( 'Featured image border radius','kid-toys-store' ),
		'section' => 'kid_toys_store_blog_post',
		'type'  => 'number',
		'input_attrs' => array(
			'step' => 1,
    ...
    $wp_customize->add_setting( 'kid_toys_store_featured_image_box_shadow', array(
		'default' => 0,
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	) );
	$wp_customize->add_control( 'kid_toys_store_featured_image_box_shadow', array(
		'label' => __( 'Featured image box shadow','kid-toys-store' ),
		'section' => 'kid_toys_store_blog_post',
		'type'  => 'number',
		'input_attrs' => array(
			'step' => 1,
	...
	$wp_customize->add_setting( 'kid_toys_store_post_button_text', array(
		'default'   => __('Read Full','kid-toys-store' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	...
	$wp_customize->add_setting( 'kid_toys_store_post_blocks', array(
        'default'			=> 'Within box',
        'sanitize_callback'	=> 'kid_toys_store_sanitize_choices'
    ));
    $wp_customize->add_control( 'kid_toys_store_post_blocks', array(
        'section' => 'kid_toys_store_blog_post',
        'type' => 'select',
        'label' => __( 'Post blocks', 'kid-toys-store' ),
        'choices' => array(
            'Within box'  => __( 'Within box', 'kid-toys-store' ),
            'Without box' => __( 'Without box', 'kid-toys-store' ),
    )));

    $wp_customize->add_setting('kid_toys_store_navigation_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('kid_toys_store_navigation_hide',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Post Navigation','kid-toys-store'),
       'section' => 'kid_toys_store_blog_post'
    ));

    $wp_customize->add_setting( 'kid_toys_store_post_navigation_type', array(
        'default'			=> 'numbers',
        'sanitize_callback'	=> 'kid_toys_store_sanitize_choices'
    ));
    $wp_customize->add_control( 'kid_toys_store_post_navigation_type', array(
        'section' => 'kid_toys_store_blog_post',
        'type' => 'select',
        'label' => __( 'Post Navigation Type', 'kid-toys-store' ),
        'choices'		=> array(
            'numbers'  => __( 'Number', 'kid-toys-store' ),
            'next-prev' => __( 'Next/Prev Button', 'kid-toys-store' ),
    )));

    $wp_customize->add_setting( 'kid_toys_store_post_navigation_position', array(
        'default'			=> 'bottom',
        'sanitize_callback'	=> 'kid_toys_store_sanitize_choices'
    ));
    $wp_customize->add_control( 'kid_toys_store_post_navigation_position', array(
        'section' => 'kid_toys_store_blog_post',
        'type' => 'select',
        'label' => __( 'Post Navigation Position', 'kid-toys-store' ),
        'choices' => array(
            'top'  => __( 'Top', 'kid-toys-store' ),
            'bottom' => __( 'Bottom', 'kid-toys-store' ),
            'both' => __( 'Both', 'kid-toys-store' ),
    )));
    ...
    $wp_customize->add_setting('kid_toys_store_single_post_time_hide',array(
       'default' => false,
       'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('kid_toys_store_single_post_time_hide',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Time','kid-toys-store'),
       'section' => 'kid_toys_store_single_post'
    ));

    $wp_customize->add_setting( 'kid_toys_store_comment_width', array(
		'default' => 100,
		'sanitize_callback'	=> 'kid_toys_store_sanitize_float'
	) );
	$wp_customize->add_control( 'kid_toys_store_comment_width', array(
		'label' => __( 'Comment Textarea Width', 'kid-toys-store'),
		'section' => 'kid_toys_store_single_post',
		'type' => 'number',
		'settings' => 'kid_toys_store_comment_width',
		'input_attrs' => array(
			'step' => 1,
			'min' => 0,
			'max' => 100,
    ...
    $wp_customize->add_setting('kid_toys_store_comment_title',array(
       'default' => __('Leave a Reply','kid-toys-store' ),
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('kid_toys_store_comment_title',array(
       'type' => 'text',
       'label' => __('Comment form Title','kid-toys-store'),
       'section' => 'kid_toys_store_single_post'
    ));

    $wp_customize->add_setting('kid_toys_store_comment_submit_text',array(
       'default' => __('Post Comment','kid-toys-store' ),
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('kid_toys_store_comment_submit_text',array(
       'type' => 'text',
       'label' => __('Comment Button Text','kid-toys-store'),
       'section' => 'kid_toys_store_single_post'
    ));
	...
	$wp_customize->add_section('kid_toys_store_404_page',array(
		'title'	=> __('404 & No Result Page Settings','kid-toys-store'),
		'priority'	=> null,
		'panel' => 'kid_toys_store_panel_id',
	));
    ...
    $wp_customize->add_setting('kid_toys_store_no_result_title',array(
       'default' => '',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('kid_toys_store_no_result_title',array(
       'type' => 'text',
       'label' => __('No Result Page Title','kid-toys-store'),
       'section' => 'kid_toys_store_404_page'
    ));

    $wp_customize->add_setting('kid_toys_store_no_result_text',array(
       'default' => '',
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('kid_toys_store_no_result_text',array(
       'type' => 'text',
       'label' => __('No Result Page Text','kid-toys-store'),
       'section' => 'kid_toys_store_404_page'
    ));

    $wp_customize->add_setting('kid_toys_store_show_search_form',array(
        'default' => true,
        'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
	));
	$wp_customize->add_control('kid_toys_store_show_search_form',array(
     	'type' => 'checkbox',
      	'label' => __('Show/Hide Search Form','kid-toys-store'),
      	'section' => 'kid_toys_store_404_page',
	));
	...
	$wp_customize->add_setting('kid_toys_store_back_to_top_icon',array(
		'default'	=> 'fas fa-arrow-up',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_back_to_top_icon',array(
		'label'	=> __('Back to Top Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_footer',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('kid_toys_store_back_to_top_text',array(
		'default'	=> '',
		'sanitize_callback'	=> 'sanitize_text_field',
	));	
	$wp_customize->add_control('kid_toys_store_back_to_top_text',array(
		'label'	=> __('Back to Top Button Text','kid-toys-store'),
		'section'	=> 'kid_toys_store_footer',
		'type'		=> 'text'
	));
	...
	$wp_customize->add_setting('kid_toys_store_footer_background_color', array(
		'default'           => '#000',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'kid_toys_store_footer_background_color', array(
		'label'    => __('Footer Background Color', 'kid-toys-store'),
		'section'  => 'kid_toys_store_footer',
	)));

	$wp_customize->add_setting('kid_toys_store_footer_background_img',array(
		'default'	=> '',
		'sanitize_callback'	=> 'esc_url_raw',
	));
	$wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'kid_toys_store_footer_background_img',array(
        'label' => __('Footer Background Image','kid-toys-store'),
        'section' => 'kid_toys_store_footer'
	)));
	...
	$wp_customize->add_control('kid_toys_store_footer_copy',array(
		'label'	=> __('Copyright Text','kid-toys-store'),
		'section'=> 'kid_toys_store_footer',
    ...
    $wp_customize->add_setting('kid_toys_store_copyright_background_color', array(
		'default'           => '#ffde3f',
		'sanitize_callback' => 'sanitize_hex_color',
	));
	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'kid_toys_store_copyright_background_color', array(
		'label'    => __('Copyright Background Color', 'kid-toys-store'),
		'section'  => 'kid_toys_store_footer',
	)));

	//Mobile Media Section
	$wp_customize->add_section( 'kid_toys_store_mobile_media_options' , array(
    	'title'      => __( 'Mobile Media Options', 'kid-toys-store' ),
		'priority'   => null,
		'panel' => 'kid_toys_store_panel_id'
	) );

	$wp_customize->add_setting('kid_toys_store_responsive_open_menu_icon',array(
		'default'	=> 'fas fa-bars',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_responsive_open_menu_icon',array(
		'label'	=> __('Open Menu Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_mobile_media_options',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting('kid_toys_store_responsive_close_menu_icon',array(
		'default'	=> 'fas fa-times',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	$wp_customize->add_control(new Kid_Toys_Store_Icon_Changer(
        $wp_customize, 'kid_toys_store_responsive_close_menu_icon',array(
		'label'	=> __('Close Menu Icon','kid-toys-store'),
		'section'	=> 'kid_toys_store_mobile_media_options',
		'type'		=> 'icon'
	)));

	$wp_customize->add_setting( 'kid_toys_store_responsive_topbar_hide',array(
		'default' => false,
      	'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ) );
    $wp_customize->add_control('kid_toys_store_responsive_topbar_hide',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Topbar','kid-toys-store' ),
        'section' => 'kid_toys_store_mobile_media_options'
    ));

    $wp_customize->add_setting('kid_toys_store_mobile_media_slider',array(
       'default' => false,
       'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ));
    $wp_customize->add_control('kid_toys_store_mobile_media_slider',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Slider','kid-toys-store'),
       'section' => 'kid_toys_store_mobile_media_options'
    ));

    $wp_customize->add_setting('kid_toys_store_responsive_show_back_to_top',array(
        'default' => true,
        'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
	));
	$wp_customize->add_control('kid_toys_store_responsive_show_back_to_top',array(
     	'type' => 'checkbox',
      	'label' => __('Show / Hide Back to Top Button','kid-toys-store'),
      	'section' => 'kid_toys_store_mobile_media_options',
	));

	$wp_customize->add_setting( 'kid_toys_store_responsive_preloader_hide',array(
		'default' => false,
      	'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
    ) );
    $wp_customize->add_control('kid_toys_store_responsive_preloader_hide',array(
    	'type' => 'checkbox',
        'label' => __( 'Show / Hide Preloader','kid-toys-store' ),
        'section' => 'kid_toys_store_mobile_media_options'
    ));
	...
	$wp_customize->add_setting('kid_toys_store_shop_page_pagination',array(
		'default' => true,
		'sanitize_callback'	=> 'kid_toys_store_sanitize_checkbox'
	 ));
	 $wp_customize->add_control('kid_toys_store_shop_page_pagination',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Shop page pagination','kid-toys-store'),
		'section' => 'kid_toys_store_woocommerce_options',
	 ));
	...
	$wp_customize->add_setting('kid_toys_store_sale_position',array(
        'default' => 'right',
        'sanitize_callback' => 'kid_toys_store_sanitize_choices'
	));
	$wp_customize->add_control('kid_toys_store_sale_position',array(
        'type' => 'select',
        'label' => __('Sale badge Position','kid-toys-store'),
        'section' => 'kid_toys_store_woocommerce_options',
        'choices' => array(
            'left' => __('Left','kid-toys-store'),
            'right' => __('Right','kid-toys-store'),
	...
	$wp_customize->add_setting( 'kid_toys_store_woocommerce_sale_top_padding',array(
		'default' => 0,
		'sanitize_callback' => 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control( 'kid_toys_store_woocommerce_sale_top_padding',	array(
		'label' => esc_html__( 'Sale Top Bottom Padding','kid-toys-store' ),
		'type' => 'number',
		'section' => 'kid_toys_store_woocommerce_options',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting( 'kid_toys_store_woocommerce_sale_left_padding',array(
	 	'default' => 0,
	 	'sanitize_callback' => 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_woocommerce_sale_left_padding',	array(
	 	'label' => esc_html__( 'Sale Right Left Padding','kid-toys-store' ),
		'type' => 'number',
		'section' => 'kid_toys_store_woocommerce_options',
	 	'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting( 'kid_toys_store_woocommerce_sale_border_radius',array(
		'default' => 50,
		'sanitize_callback' => 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_woocommerce_sale_border_radius',array(
		'label' => esc_html__( 'Sale Border Radius','kid-toys-store' ),
		'type' => 'number',
		'section' => 'kid_toys_store_woocommerce_options',
		'input_attrs' => array(
			'min' => 0,
	...
	$wp_customize->add_setting( 'kid_toys_store_product_sale_font_size',array(
		'default' => 16,
		'sanitize_callback' => 'kid_toys_store_sanitize_float'
	));
	$wp_customize->add_control('kid_toys_store_product_sale_font_size',array(
		'label' => esc_html__( 'Sale Font Size','kid-toys-store' ),
		'type' => 'number',
		'section' => 'kid_toys_store_woocommerce_options',
		'input_attrs' => array(
			'min' => 0,
...
final class Kid_Toys_Store_Customizer_Upsell {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'kid-toys-store-upsell-js', trailingslashit( esc_url(get_template_directory_uri()) ) . 'inc/js/kid-customize-controls.js', array( 'customize-controls' ) );

		wp_enqueue_style( 'kid-toys-store-theme-info-style', trailingslashit( esc_url(get_template_directory_uri()) ) . 'inc/css/customize-control.css' );
	}
}
