...
<main id="main" role="main">
	...
	<?php if( get_theme_mod('kid_toys_store_slider_arrows') != '' || get_theme_mod( 'kid_toys_store_mobile_media_slider', false) != ''){ ?>
		<section id="slider">
		  	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel" data-bs-interval="<?php echo esc_attr(get_theme_mod( 'kid_toys_store_slider_speed',3000)); ?>"> 
			          	...
			          	<div class="carousel-caption">
				            <div class="inner_carousel">
				            	<?php if( get_theme_mod('kid_toys_store_slider_title',true) != ''){ ?>
				              		<h1 class="p-0 mb-2"><a href="<?php echo esc_url( get_permalink() );?>"><?php esc_html(the_title()); ?><span class="screen-reader-text"><?php esc_html(the_title()); ?></span></a></h1>
				              	<?php }?>
